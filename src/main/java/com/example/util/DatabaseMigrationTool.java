...
public class DatabaseMigrationTool {
    ...
    public void executeMigration() {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl, username, password)) {
            ...
            // Division du script en instructions individuelles
            String[] instructions = migrationScript.split(";");

            // Exécuter les instruction
            ...
            System.out.println("\n____  Migration terminée avec succès! ____");
    ...
    public static void main(String[] args) {
        ...
        DatabaseMigrationTool migrationTool = new DatabaseMigrationTool(
                "jdbc:mysql://localhost:3306/reservation_salles?allowMultiQueries=true",
                "root",
                ""
        );
